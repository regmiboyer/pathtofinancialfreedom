# PORT-TODO — Strategy II — Mortgage & ETF Investment

**Status:** stub (returns `501 Not Implemented` for all requests)
**Port:** 4002
**Internal key in index.html:** `mei`

## What to port

Search index.html for the 'mei' section / Strategy II markers and calcMinPmt(). Tightly coupled to Strategy IV (reads live property settings) — port together per JIRA-88.2.
