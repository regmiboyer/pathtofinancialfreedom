# PORT-TODO — Strategy IV — High Touch Property Portfolio

**Status:** stub (returns `501 Not Implemented` for all requests)
**Port:** 4004
**Internal key in index.html:** `compare`

## What to port

Search index.html for 'pfSection' / pf-prefixed functions (calcStampDuty, calcMonthlyPayment, etc). Tightly coupled to Strategy II — port together per JIRA-88.2.
