# PORT-TODO — Strategy V — Precious Metals Portfolio

**Status:** stub (returns `501 Not Implemented` for all requests)
**Port:** 4005
**Internal key in index.html:** `precious`

## What to port

Search index.html for 'preciousSection' / pm-prefixed functions. Self-contained — JIRA-88.3.
