# PORT-TODO — Strategy VIII — VOO vs V500 on Stake

**Status:** stub (returns `501 Not Implemented` for all requests)
**Port:** 4008
**Internal key in index.html:** `voo500`

## What to port

Search index.html for 'voo500Section' / voo500-prefixed functions. Lower priority — JIRA-88.4.
